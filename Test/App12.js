...
function PracticeFormScreen({ navigation }) {
  ...
  const [heights, setHeights] = useState([]); // [{id, heightIn, attempts:[{result, idx}], poleIdx}]
  ...
  const save = () => {
    ...
    const sess = {
      ...
      heights, // each height has poleIdx
      notes,
      routine: routine.map(({ text, done, isHeader }) => ({ text, done: !!done, isHeader: !!isHeader })),
    };
    add(sess);
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalCard}>
              ...
              <Field label="Length (ft/in or cm)">
                <TextInput value={poleLength} onChangeText={setPoleLength} placeholder="e.g., 13'6\" style={styles.input} />
              </Field>
              ...
              <Row style={{ justifyContent: 'flex-end', gap: 8 }}>
                <ButtonSecondary title="Cancel" onPress={() => setPoleModalOpen(false)} />
    ...
    units === 'imperial' ? (
      <View>
        ...
        <ButtonPrimary
          title="Add Height"
          onPress={handleAddHeightImperial}
          style={{ marginTop: 8, alignSelf: 'flex-start', paddingHorizontal: 0, paddingLeft: 9, paddingRight: 9, marginLeft: 14 }}
        />
      </View>
    ) : (
      <View>
        ...
        <ButtonPrimary
          title="Add Height"
          onPress={handleAddHeightMetric}
          style={{ marginTop: 8, alignSelf: 'flex-start', paddingHorizontal: 0, paddingLeft: 9, paddingRight: 9, marginLeft: 14, minWidth: undefined }}
        />
      </View>
    );
  // Takeoff Mark Dropdown
